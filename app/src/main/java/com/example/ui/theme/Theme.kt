...
fun MyApplicationTheme(
  darkTheme: Boolean = true, // Force beautiful dark dream mode by default!
  // Dynamic color is available on Android 12+
  dynamicColor: Boolean = false, // Use our handcrafted Cosmic colors instead of system colors
